...
export const Working = () => {
      ...
      stepRefs.current.forEach((step, index) => {
        gsap.fromTo(
          ...
          { opacity: 0, scale: 0.8 },
          {
            ...
            scrollTrigger: {
              trigger: step,
              start: "bottom bottom", // Animation starts when step is in the center of the viewport
  ...
  return (
    <section className="how-it-works" ref={sectionRef} id="working">
      ...
      <section className="steps">
        <div className="step step2" ref={(el) => (stepRefs.current[0] = el)}>
          <div className="icon">
            <i className="ri-roadster-fill"></i>
          </div>
          <div className="step-text">
            <h5>Mode of Trip and vehicle</h5>
            <p>Easily select the perfect car for your transportation</p>
          </div>
        </div>

        <div className="line" ref={(el) => (lineRefs.current[0] = el)}></div>

        <div className="step step1" ref={(el) => (stepRefs.current[1] = el)}>
          <div className="icon">
            <i className="ri-map-pin-fill"></i>
          </div>
          <div className="step-text">
            <h5>Pick-Up and Drop Location</h5>
            <p>Easily select the perfect location for your car</p>
          </div>
        </div>

        <div className="line" ref={(el) => (lineRefs.current[1] = el)}></div>

        <div className="step step2" ref={(el) => (stepRefs.current[2] = el)}>
          <div className="icon">
            <i className="ri-calendar-schedule-fill"></i>
          </div>
          <div className="step-text">
            <h5>Pick-Up and Drop Date</h5>
        ...
        <div className="step step3" ref={(el) => (stepRefs.current[3] = el)}>
          <div className="icon">
